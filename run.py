...
from visonic_decoder.config import LOG_FILES_TO_KEEP, LOG_LEVEL, LOG_TO_FILE
from visonic_decoder.visonic import Runner

handlers = [logging.StreamHandler(sys.stdout)]
f_handler = RotatingFileHandler(
    "./visonic_decoder/logs/message.log", backupCount=LOG_FILES_TO_KEEP
)
